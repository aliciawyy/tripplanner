...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _materialDatetimePicker = __webpack_require__(5);
	...
	form.addEventListener("submit", function (event) {
		...
		var place = document.querySelector("input[name='options']").value;

		//TODO get dates (duration)
		//TODO 
		var duration = 3;

		var xhr = new XMLHttpRequest();
		var mapData = void 0;
		var params = 'cityName=' + encodeURIComponent(cityName) + '&places=' + encodeURIComponent(place) + '&duration=' + duration;
		console.log(params);
		///home/GetPlans?cityName=paris&places=museum,library&duration=3
		//	xhr.open("GET", "http://ca65a989.ngrok.io/home/RunJson?cityName=paris&place=museum", false);
		//xhr.open("GET", `http://ca65a989.ngrok.io/home/GetPlans?${params}`, false);
		xhr.open("GET", '/../paris.json', false);
		xhr.setRequestHeader("Access-Control-Allow-Origin", "*");
		xhr.setRequestHeader("Content-Type", "application/jsonp");
		xhr.send();
		console.log(xhr.status);
		if (xhr.status == 200) {
			//console.log(mapData.Activities);
			...
			try {
				for (var _iterator = mapData[0].Activities[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
					var activity = _step.value;

					console.log("here");
					console.log(activity.Id);
					addPlace(activity.Id);
				}

				//TODO render activities by day
				//Show map with activities
				// document.body.append("<script async defer    src=\"https://maps.googleapis.com/maps/api/js?key=AIzaSyDJe89WAZmJd1aRIUdmlAZBhG5JRx6Np40&libraries=places&callback=initMap\"\"></script>");
				//page.innerHTML()
				//initMap();
			} catch (err) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
		 true ? module.exports = factory(__webpack_require__(6), __webpack_require__(7)) :
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var rome = __webpack_require__(95);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var use = __webpack_require__(142);

	core.use = use.bind(core);
	core.find = index.find;
	core.val = __webpack_require__(143);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var inline = __webpack_require__(141);
	var isInput = __webpack_require__(128);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var crossvent = __webpack_require__(108);
	var bullseye = __webpack_require__(111);
	...
	var momentum = __webpack_require__(125);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var customEvent = __webpack_require__(109);
	var eventmap = __webpack_require__(110);
	var doc = document;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var tailormade = __webpack_require__(113);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var sell = __webpack_require__(114);
	var crossvent = __webpack_require__(108);
	var seleccion = __webpack_require__(115);
	var throttle = __webpack_require__(112);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getSelection = __webpack_require__(116);
	var setSelection = __webpack_require__(122);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getSelectionRaw = __webpack_require__(117);
	var getSelectionNullOp = __webpack_require__(118);
	var getSelectionSynthetic = __webpack_require__(119);
	var isHost = __webpack_require__(121);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var rangeToTextRange = __webpack_require__(120);
	var doc = global.document;
	var body = doc.body;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var text = __webpack_require__(138);
	var parse = __webpack_require__(127);
	var clone = __webpack_require__(124);
	var defaults = __webpack_require__(126);
	var momentum = __webpack_require__(125);
	var classes = __webpack_require__(139);
	var noop = __webpack_require__(140);
	var no;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var atoa = __webpack_require__(131);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var index = __webpack_require__(106);
	var parse = __webpack_require__(127);
	var association = __webpack_require__(144);
